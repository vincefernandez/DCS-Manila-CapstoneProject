...
class myStudent
{
    ...
    // $cleardb_username ='b7ef41912e223b';
    // $cleardb_password ='3cc18d32';
    ...
    public function OpenConnection()
    {
        ...
        try {
            ...
            $this->con = new PDO("mysql:host=".$cleardb_server."dbname=".$cleardb_db, $cleardb_username, $cleardb_password);
