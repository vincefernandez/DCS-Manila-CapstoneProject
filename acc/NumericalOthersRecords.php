               ...
               <li class="nav-header">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="NumericalOthersRecords.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Others</p>
                                    </a>
                                </li>
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <!-- Change This -->
                            <a href='../acc/NumericalOthers.php'><button class="btn btn-primary">Add Records</button></a>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <!-- <li class="breadcrumb-item"><a href="NumericalOthers.php">Add Record</a></li> -->
            ...
            <section class="content">
                <div class="container-fluid table-responsive">
                    <table id="example" class="table table-bordered dt-responsive" style="width:100%">
                        ...
                        <tbody>
                            <?php $student->DisplayNumericalOthersRecords() ?>
                        </tbody>
                    </table>
                </div>
            </section>
