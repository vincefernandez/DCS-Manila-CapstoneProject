            ...
            <div class="sidebar">
              ...
              <i class="fas fa-search fa-fw"></i>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="RRMHighschoolQ.php" class="nav-link ">
                        ...
                        <li class="nav-item">
                            <a href="201FilesRRMHS.php" class="nav-link active">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <!-- Change This -->
                            <a href='../acc/RRMHS.php'><button class="btn btn-primary">Add Records</button></a>
                        </div>
                        <div class="col-sm-6">
            ...
            <section class="content">
                <div class="container-fluid table-responsive">
                    <table id="example" class="table table-bordered dt-responsive" style="width:100%">
                        ...
                        <tbody>
                            <?php $student->DisplayAppointmentClearanceRRM() ?>
                        </tbody>
                    </table>
                </div>
            </section>
