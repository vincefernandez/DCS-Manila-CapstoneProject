        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="Cav.php" class="nav-link">Add Record</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="cavList.php" class="nav-link">ALL RECORDS</a>
                </li>
            </ul>
        ...
        <div class="content-wrapper">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="cavList.php">All Records</a></li>
            ...
            <section class="add-record-flex-section content">
                <div class="container-add-record">
                    ...
                    <form action="Cav.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="user-details-add-record">
                            ...
                            <!--END OF DIV-->
                            <div class="input-box-add-record">
                                <span class="add-record-details">District</span>
                                <input type="text" name="District" placeholder="Enter District..">
                            </div>
                            <div class="input-box-add-record">
                                <span class="add-record-details">Year</span>
