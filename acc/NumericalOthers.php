        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="NumericalOthers.php" class="nav-link">Add Record</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="NumericalOtherslist.php" class="nav-link">ALL RECORDS</a>
                </li>
            </ul>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="numericalOtherslist.php">All Records</a></li>
