...
$student->DeleteFirstRowHS();
session_start();
$fullname = $_SESSION['FullName'];
if ($_SESSION['Account_Type'] !== 'RRMHighSchool') {
            ...
            <div class="sidebar">
              ...
              <i class="fas fa-search fa-fw"></i>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="RRMHighschoolQ.php" class="nav-link active">
                        ...
                        <li class="nav-item">
                            <a href="RRMListHS.php" class="nav-link ">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>
                                    All Records
                                    <!-- <i class="right fas fa-angle-left"></i> -->
                        ...
                        <li class="nav-item">
                            <a href="RRMHSAdministrative.php" class="nav-link">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>
                        ...
                        <li class="nav-item">
                            <a href="CAVRRMHS.php" class="nav-link">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="RRMHSNumerical.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Communication</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="RRMHSNumericalOthers.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Others</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="201FilesRRMHS.php" class="nav-link">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>
                ...
                <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <div>
                                <a href='RRMHighschoolQ.php?Delete' class="btn btn-primary text-center" style="text-align: center !important;">Next</a>
                            </div>
                        </div>
    ...
    <script>
        function WaitingList() {
            setInterval(function() {
                ...
                xhttp.open("GET", "../app/WaitinglistHS.php", true);
        ...
        function Processed() {
            setInterval(function() {
                ...
                xhttp.open("GET", "../app/ProcessedHS.php", true);
                xhttp.send();
            }, 1000);
        ...
        function NowServing() {
            setInterval(function() {
                ...
                // xhttp.open("GET", "../app/Waitinglist.php", true);
                xhttp.open("GET", "../app/NowServingHS.php", true);
                xhttp.send();
            }, 1000);
