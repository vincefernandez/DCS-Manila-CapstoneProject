            ...
            <div class="sidebar">
              ...
              <i class="fas fa-search fa-fw"></i>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="AdministrativeIssuance_RecordList.php" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="Acc_AdministrativeIssuance.php" class="nav-link active">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>
                                    Add Records
                                    <!-- <i class="right fas fa-angle-left"></i> -->
                    ...
                    <div class="card col-12">
                        <div class="card-body">
                            ...
                            <div class="shadow-lg mb-5 bg-body rounded">
                                <div class="card-header bg-secondary h-500 mb-3">
                                    <p>Add Records</p>
                                </div>


                                <form method="POST" action="Acc_AdministrativeIssuance.php" enctype="multipart/form-data">
                                    <div class="card">
                                        <div class="row" style="background-color:#ffdd99">
                                            ...
                                            <div class="col-6">
                                                <div class="mb-3">
                                                    <label for="exampleInputEmail1" class="form-label">Control Number</label>
                                                    <input type="text" class="form-control" name="Control_Number">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="mb-3">
                                                    <label for="exampleInputEmail1" class="form-label">Memorandum Number</label>
                                                    <input type="text" class="form-control" name="Memorandum_Number">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="mb-3">
                                            ...
                                            <div class="d-flex justify-content-right">
                                                ...
                                                <button type="Submit" name="AdministrativeIssuanceAddrecords" class="btn btn-primary">
                                                    Submit
                                                </button>
