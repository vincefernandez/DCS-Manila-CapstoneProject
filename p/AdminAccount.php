  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="#" class="nav-link">Manage Section</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <a href="" class="nav-link">Manage Queueing</a>
        </li>
      </ul>
          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <div class="small-box bg-info">
                ...
                <a href="Admin-ManageAccount.php" class="small-box-footer">
            ...
            <div class="col-md-4">
              ...
              <div class="small-box bg-info">
                <div class="inner">
                  ...
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam, quis.</p>
                </div>
                <div class="icon">
                  <i class="fas fa-shopping-cart"></i>
                </div>
            ...
            <div class="col-md-4">
              ...
              <div class="small-box bg-info">
                ...
                <a href="Q-Home.php" class="small-box-footer">
                  More info <i class="fas fa-arrow-circle-right"></i>
                </a>
              </div>
            </div>
