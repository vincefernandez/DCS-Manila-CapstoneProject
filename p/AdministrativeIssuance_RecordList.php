            ...
            <div class="sidebar">
              ...
              <i class="fas fa-search fa-fw"></i>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="AdministrativeIssuance_RecordList.php" class="nav-link active">
                        ...
                        <li class="nav-item">
                            <a href="Acc_AdministrativeIssuance.php" class="nav-link ">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>
                                    Add Records
                                    <!-- <i class="right fas fa-angle-left"></i> -->
                    ...
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <table id="example" class="table table-bordered dt-responsive" style="width: 100%;">
                                ...
                                <tbody>
                                    <?php $student->DisplayAdministrativeIssuance() ?>
                                </tbody>
